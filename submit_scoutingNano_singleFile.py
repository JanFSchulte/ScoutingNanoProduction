...
#    'Zto2Q_HT-800to1500':'/Zto2Q-4Jets_Bin-HT-800to1500_TuneCP5_13p6TeV_madgraphMLM-pythia8/RunIII2024Summer24MiniAODv6-150X_mcRun3_2024_realistic_v2-v2/MINIAODSIM',
    ...
    'ZZto4L' : '/ZZto4L-1Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/RunIII2024Summer24MiniAODv6-150X_mcRun3_2024_realistic_v2-v2/MINIAODSIM',
...
parser.add_argument('--part', type=int, help='Only submit this data part, starting from 1')
...
def get_cached_files(sample, dataset):
    os.makedirs(CACHE_DIR, exist_ok=True)
    cache_path = os.path.join(CACHE_DIR, f'{sample}_allfiles.json')
    ...
    print(f'  [{sample}] Querying files in dataset...')
    files = sorted(das_query(f'file dataset={dataset}'))
...
if not args.resubmit and not args.report:
  ...
  "/store/data/Run2025C/ScoutingPFRun3/HLTSCOUT/v1/000/392/175/00000/0925988b-2e5a-4e36-8ad9-3de7117d01fb.root",
    ...
    for i, file_chunk in enumerate(task_chunks):
        ...
        if args.sonic:
            cfg.JobType.psetName = 'scoutingnano_mc_standalone2.py' if args.mc else 'scoutingnano_data_standalone_sonic.py'
        else:    
