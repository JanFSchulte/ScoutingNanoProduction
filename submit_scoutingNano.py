...
if not args.resubmit:
  ...
  for sample, dataset in samples.items():
    ...
    for i, file_chunk in enumerate(task_chunks):
        ...
        cfg.Data.outputDatasetTag = f'ScoutingNano_{mode_label}_{sample}{suffix}_v4_redo'
        ...
        cfg.Site.blacklist = ['T2_BR_UERJ', 'T2_US_Florida', 'T2_US_Wisconsin', 'T2_US_Caltech']
